...
type: design
project: mvp
clears: [what-the-skill-teaches-versus-what-the-repo-documents]
---
...
- **The shipped skill**, installed into a target repo. Teaches method: how to chart a map from a loose idea, how
  to walk one a ticket at a time, and how to graduate a patch. It ships to strangers, so it can assume nothing
  about the repo it lands in.
